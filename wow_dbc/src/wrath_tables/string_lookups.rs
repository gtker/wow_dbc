...
impl DbcTable for StringLookups {
    ...
    fn write(&self, w: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            // string: string_ref
            b.write_all(&string_cache.add_string(&row.string).to_le_bytes())?;
...
impl TryFrom<u32> for StringLookupsKey {
    type Error = u32;
...
mod test {
    ...
    fn string_lookups() {
        let mut file = File::open("../wrath-dbc/StringLookups.dbc").expect("Failed to open DBC file");
