...
use crate::wrath_tables::spell_effect_camera_shakes::*;
...
impl DbcTable for SpellVisualKit {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // start_anim_id: foreign_key (AnimationData) int32
            let start_anim_id = AnimationDataKey::new(crate::util::read_i32_le(chunk)?.into());
    ...
    fn write(&self, b: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            // start_anim_id: foreign_key (AnimationData) int32
            b.write_all(&(row.start_anim_id.id as i32).to_le_bytes())?;
    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            SpellVisualKitRow {
                ...
                start_anim_id: AnimationDataKey::new(0),
                ...
                shake_id: SpellEffectCameraShakesKey::new(0),
                char_proc: [0; 4],
                char_param_zero: [0.0; 4],
                char_param_one: [0.0; 4],
                char_param_two: [0.0; 4],
                char_param_three: [0.0; 4],
                flags: 0,
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (SpellVisualKit) int32
            let id = SpellVisualKitKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // start_anim_id: foreign_key (AnimationData) int32
            let start_anim_id = AnimationDataKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // head_effect: int32
            let head_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // chest_effect: int32
            let chest_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // base_effect: int32
            let base_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // left_hand_effect: int32
            let left_hand_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // right_hand_effect: int32
            let right_hand_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // breath_effect: int32
            let breath_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // left_weapon_effect: int32
            let left_weapon_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // right_weapon_effect: int32
            let right_weapon_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // world_effect: int32
            let world_effect = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // shake_id: foreign_key (SpellEffectCameraShakes) int32
            let shake_id = SpellEffectCameraShakesKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
    ...
    pub fn to_owned(&self) -> SpellVisualKit {
        SpellVisualKit {
            rows: self.rows.iter().map(|s| SpellVisualKitRow {
                ...
                char_param_three: s.char_param_three,
                flags: s.flags,
            }).collect(),
        }
    }
...
pub struct SpellVisualKitRow {
    ...
    pub start_anim_id: AnimationDataKey,
