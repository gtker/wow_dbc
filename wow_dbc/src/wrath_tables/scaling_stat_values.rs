...
impl TryFrom<usize> for ScalingStatValuesKey {
    type Error = usize;
...
impl TryFrom<u64> for ScalingStatValuesKey {
    type Error = u64;
...
impl TryFrom<i64> for ScalingStatValuesKey {
    type Error = i64;
...
impl TryFrom<isize> for ScalingStatValuesKey {
    type Error = isize;
