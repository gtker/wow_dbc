...
pub struct ConstScalingStatValues<const S: usize> {
    pub rows: [ScalingStatValuesRow; S],
}

impl<const S: usize> ConstScalingStatValues<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ScalingStatValuesRow {
                ...
                weapon_d_p_s1_h: 0,
                weapon_d_p_s2_h: 0,
                spellcaster_d_p_s1_h: 0,
                spellcaster_d_p_s2_h: 0,
                ranged_d_p_s: 0,
                wand_d_p_s: 0,
                spell_power: 0,
                primary_budget: 0,
        ...
        while i < S {
            // id: primary_key (ScalingStatValues) int32
            let id = ScalingStatValuesKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // charlevel: int32
            let charlevel = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // shoulder_budget: int32
            let shoulder_budget = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // trinket_budget: int32
            let trinket_budget = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // weapon_budget1_h: int32
            let weapon_budget1_h = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ranged_budget: int32
            let ranged_budget = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // cloth_shoulder_armor: int32
            let cloth_shoulder_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // leather_shoulder_armor: int32
            let leather_shoulder_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // mail_shoulder_armor: int32
            let mail_shoulder_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // plate_shoulder_armor: int32
            let plate_shoulder_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // weapon_d_p_s1_h: int32
            let weapon_d_p_s1_h = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // weapon_d_p_s2_h: int32
            let weapon_d_p_s2_h = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // spellcaster_d_p_s1_h: int32
            let spellcaster_d_p_s1_h = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // spellcaster_d_p_s2_h: int32
            let spellcaster_d_p_s2_h = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ranged_d_p_s: int32
            let ranged_d_p_s = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // wand_d_p_s: int32
            let wand_d_p_s = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // spell_power: int32
            let spell_power = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // primary_budget: int32
            let primary_budget = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // tertiary_budget: int32
            let tertiary_budget = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // cloth_cloak_armor: int32
            let cloth_cloak_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // cloth_chest_armor: int32
            let cloth_chest_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // leather_chest_armor: int32
            let leather_chest_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // mail_chest_armor: int32
            let mail_chest_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // plate_chest_armor: int32
            let plate_chest_armor = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            rows[i] = ScalingStatValuesRow {
                id,
                charlevel,
                shoulder_budget,
                trinket_budget,
