...
impl From<i8> for GMSurveySurveysKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
}

impl From<i16> for GMSurveySurveysKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
}

impl From<i32> for GMSurveySurveysKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
}

impl TryFrom<u32> for GMSurveySurveysKey {
    type Error = u32;
...
impl TryFrom<usize> for GMSurveySurveysKey {
    type Error = usize;
...
impl TryFrom<u64> for GMSurveySurveysKey {
    type Error = u64;
...
impl TryFrom<i64> for GMSurveySurveysKey {
    type Error = i64;
...
impl TryFrom<isize> for GMSurveySurveysKey {
    type Error = isize;
...
mod test {
    ...
    fn gm_survey_surveys() {
        let mut file = File::open("../wrath-dbc/GMSurveySurveys.dbc").expect("Failed to open DBC file");
