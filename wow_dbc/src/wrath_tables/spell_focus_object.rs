...
impl DbcTable for SpellFocusObject {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (SpellFocusObject) int32
            let id = SpellFocusObjectKey::new(crate::util::read_i32_le(chunk)?);
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstSpellFocusObject<const S: usize> {
    pub rows: [ConstSpellFocusObjectRow; S],
}

impl<const S: usize> ConstSpellFocusObject<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut b_offset = 20;
        let mut rows = [
            ConstSpellFocusObjectRow {
                id: SpellFocusObjectKey::new(0),
        ...
        while i < S {
            // id: primary_key (SpellFocusObject) int32
            let id = SpellFocusObjectKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            rows[i] = ConstSpellFocusObjectRow {
                id,
                name_lang,
            };
            i += 1;
...
pub struct ConstSpellFocusObjectRow {
    pub id: SpellFocusObjectKey,
