...
impl DbcTable for LFGDungeonExpansion {
    ...
    fn filename() -> &'static str { "LFGDungeonExpansion.dbc" }
...
pub struct ConstLFGDungeonExpansion<const S: usize> {
    pub rows: [LFGDungeonExpansionRow; S],
}

impl<const S: usize> ConstLFGDungeonExpansion<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            LFGDungeonExpansionRow {
                id: LFGDungeonExpansionKey::new(0),
                lfg_id: 0,
                expansion_level: 0,
                random_id: 0,
                hard_level_min: 0,
        ...
        while i < S {
            // id: primary_key (LFGDungeonExpansion) int32
            let id = LFGDungeonExpansionKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // lfg_id: int32
            let lfg_id = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // random_id: int32
            let random_id = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // hard_level_min: int32
            let hard_level_min = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // hard_level_max: int32
            let hard_level_max = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
