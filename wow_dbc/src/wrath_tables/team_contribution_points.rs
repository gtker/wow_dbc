...
pub struct ConstTeamContributionPoints<const S: usize> {
    pub rows: [TeamContributionPointsRow; S],
}

impl<const S: usize> ConstTeamContributionPoints<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            TeamContributionPointsRow {
                id: TeamContributionPointsKey::new(0),
                data: 0.0,
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (TeamContributionPoints) int32
            let id = TeamContributionPointsKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            rows[i] = TeamContributionPointsRow {
                id,
                data,
            };
            i += 1;
