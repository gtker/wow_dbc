...
impl DbcTable for NamesProfanity {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            let id = NamesProfanityKey::new(crate::util::read_i32_le(chunk)?);
...
impl TryFrom<u32> for NamesProfanityKey {
    type Error = u32;
...
mod test {
    ...
    fn names_profanity() {
        let mut file = File::open("../wrath-dbc/NamesProfanity.dbc").expect("Failed to open DBC file");
