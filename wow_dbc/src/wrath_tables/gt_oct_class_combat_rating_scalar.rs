...
impl TryFrom<u32> for gtOCTClassCombatRatingScalarKey {
    type Error = u32;
...
impl TryFrom<usize> for gtOCTClassCombatRatingScalarKey {
    type Error = usize;
...
impl TryFrom<u64> for gtOCTClassCombatRatingScalarKey {
    type Error = u64;
...
impl TryFrom<i64> for gtOCTClassCombatRatingScalarKey {
    type Error = i64;
...
impl TryFrom<isize> for gtOCTClassCombatRatingScalarKey {
    type Error = isize;
...
mod test {
    ...
    fn gt_oct_class_combat_rating_scalar() {
        let mut file = File::open("../wrath-dbc/gtOCTClassCombatRatingScalar.dbc").expect("Failed to open DBC file");
        let mut contents = Vec::new();
        file.read_to_end(&mut contents).expect("Failed to read DBC file");
        let actual = gtOCTClassCombatRatingScalar::read(&mut contents.as_slice()).unwrap();
        let mut v = Vec::with_capacity(contents.len());
        actual.write(&mut v).unwrap();
        let new = gtOCTClassCombatRatingScalar::read(&mut v.as_slice()).unwrap();
