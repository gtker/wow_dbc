...
impl DbcTable for VehicleSeat {
    ...
    fn filename() -> &'static str { "VehicleSeat.dbc" }
...
pub struct ConstVehicleSeat<const S: usize> {
    pub rows: [VehicleSeatRow; S],
}

impl<const S: usize> ConstVehicleSeat<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            VehicleSeatRow {
                ...
                field_3_3_5_12213_001: 0.0,
                attachment_id: 0,
                attachment_offset: [0.0; 3],
                field_3_3_5_12213_004: 0.0,
                enter_speed: 0.0,
                enter_gravity: 0.0,
                enter_min_duration: 0.0,
                enter_max_duration: 0.0,
                enter_min_arc_height: 0.0,
                enter_max_arc_height: 0.0,
                enter_anim_start: 0,
                enter_anim_loop: 0,
                ride_anim_start: 0,
                ride_anim_loop: 0,
                ...
                field_3_3_5_12213_017: 0.0,
                exit_speed: 0.0,
                exit_gravity: 0.0,
                exit_min_duration: 0.0,
                exit_max_duration: 0.0,
                exit_min_arc_height: 0.0,
                exit_max_arc_height: 0.0,
                exit_anim_start: 0,
                exit_anim_loop: 0,
                exit_anim_end: 0,
                field_3_3_5_12213_027: 0.0,
                passenger_pitch: 0.0,
                field_3_3_5_12213_029: 0.0,
                passenger_attachment_id: 0,
                vehicle_enter_anim: 0,
                vehicle_exit_anim: 0,
                vehicle_ride_anim_loop: 0,
                field_3_3_5_12213_034: 0,
                vehicle_exit_anim_bone: 0,
                vehicle_enter_anim_bone: 0,
                field_3_3_5_12213_037: 0.0,
                field_3_3_5_12213_038: 0.0,
                vehicle_ability_display: 0,
                enter_u_i_sound_id: SoundEntriesKey::new(0),
                field_3_3_5_12213_041: 0,
                ui_skin: 0,
                field_3_3_5_12213_043: 0.0,
                field_3_3_5_12213_044: 0.0,
                field_3_3_5_12213_045: 0.0,
                field_3_3_5_12213_046: 0,
                field_3_3_5_12213_047: 0.0,
                field_3_3_5_12213_048: 0.0,
                field_3_3_5_12213_049: 0.0,
                field_3_3_5_12213_050: 0.0,
                field_3_3_5_12213_051: 0.0,
                field_3_3_5_12213_052: 0.0,
                field_3_3_5_12213_053: 0.0,
                field_3_3_5_12213_054: 0.0,
                field_3_3_5_12213_055: 0.0,
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (VehicleSeat) int32
            let id = VehicleSeatKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // field_3_3_5_12213_001: float
            let field_3_3_5_12213_001 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // field_3_3_5_12213_004: float
            let field_3_3_5_12213_004 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_speed: float
            let enter_speed = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_gravity: float
            let enter_gravity = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_min_duration: float
            let enter_min_duration = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_max_duration: float
            let enter_max_duration = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_min_arc_height: float
            let enter_min_arc_height = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_max_arc_height: float
            let enter_max_arc_height = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_anim_start: int32
            let enter_anim_start = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_anim_loop: int32
            let enter_anim_loop = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ride_anim_start: int32
            let ride_anim_start = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ride_anim_loop: int32
            let ride_anim_loop = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ride_upper_anim_start: int32
            let ride_upper_anim_start = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ride_upper_anim_loop: int32
            let ride_upper_anim_loop = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_017: float
            let field_3_3_5_12213_017 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_speed: float
            let exit_speed = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_gravity: float
            let exit_gravity = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_min_duration: float
            let exit_min_duration = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_max_duration: float
            let exit_max_duration = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_min_arc_height: float
            let exit_min_arc_height = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_max_arc_height: float
            let exit_max_arc_height = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_anim_start: int32
            let exit_anim_start = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_anim_loop: int32
            let exit_anim_loop = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // exit_anim_end: int32
            let exit_anim_end = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_027: float
            let field_3_3_5_12213_027 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // passenger_pitch: float
            let passenger_pitch = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_029: float
            let field_3_3_5_12213_029 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // passenger_attachment_id: int32
            let passenger_attachment_id = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_enter_anim: int32
            let vehicle_enter_anim = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_exit_anim: int32
            let vehicle_exit_anim = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_ride_anim_loop: int32
            let vehicle_ride_anim_loop = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_034: int32
            let field_3_3_5_12213_034 = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_exit_anim_bone: int32
            let vehicle_exit_anim_bone = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_enter_anim_bone: int32
            let vehicle_enter_anim_bone = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_037: float
            let field_3_3_5_12213_037 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_038: float
            let field_3_3_5_12213_038 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // vehicle_ability_display: int32
            let vehicle_ability_display = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // enter_u_i_sound_id: foreign_key (SoundEntries) int32
            let enter_u_i_sound_id = SoundEntriesKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // field_3_3_5_12213_041: int32
            let field_3_3_5_12213_041 = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // ui_skin: int32
            let ui_skin = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_043: float
            let field_3_3_5_12213_043 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_044: float
            let field_3_3_5_12213_044 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_045: float
            let field_3_3_5_12213_045 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_046: int32
            let field_3_3_5_12213_046 = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_047: float
            let field_3_3_5_12213_047 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_048: float
            let field_3_3_5_12213_048 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_049: float
            let field_3_3_5_12213_049 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_050: float
            let field_3_3_5_12213_050 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_051: float
            let field_3_3_5_12213_051 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_052: float
            let field_3_3_5_12213_052 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_053: float
            let field_3_3_5_12213_053 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_054: float
            let field_3_3_5_12213_054 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // field_3_3_5_12213_055: float
            let field_3_3_5_12213_055 = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            rows[i] = VehicleSeatRow {
                id,
                field_3_3_5_12213_001,
                attachment_id,
                attachment_offset,
    ...
    pub fn to_owned(&self) -> VehicleSeat {
        VehicleSeat {
            rows: self.rows.iter().map(|s| VehicleSeatRow {
                id: s.id,
                field_3_3_5_12213_001: s.field_3_3_5_12213_001,
                attachment_id: s.attachment_id,
                attachment_offset: s.attachment_offset,
                field_3_3_5_12213_004: s.field_3_3_5_12213_004,
                enter_speed: s.enter_speed,
                enter_gravity: s.enter_gravity,
                enter_min_duration: s.enter_min_duration,
                enter_max_duration: s.enter_max_duration,
                enter_min_arc_height: s.enter_min_arc_height,
                enter_max_arc_height: s.enter_max_arc_height,
                enter_anim_start: s.enter_anim_start,
                enter_anim_loop: s.enter_anim_loop,
                ride_anim_start: s.ride_anim_start,
                ride_anim_loop: s.ride_anim_loop,
                ride_upper_anim_start: s.ride_upper_anim_start,
                ride_upper_anim_loop: s.ride_upper_anim_loop,
                field_3_3_5_12213_017: s.field_3_3_5_12213_017,
                exit_speed: s.exit_speed,
                exit_gravity: s.exit_gravity,
                exit_min_duration: s.exit_min_duration,
                exit_max_duration: s.exit_max_duration,
                exit_min_arc_height: s.exit_min_arc_height,
                exit_max_arc_height: s.exit_max_arc_height,
                exit_anim_start: s.exit_anim_start,
                exit_anim_loop: s.exit_anim_loop,
                exit_anim_end: s.exit_anim_end,
                field_3_3_5_12213_027: s.field_3_3_5_12213_027,
                passenger_pitch: s.passenger_pitch,
                field_3_3_5_12213_029: s.field_3_3_5_12213_029,
                passenger_attachment_id: s.passenger_attachment_id,
                vehicle_enter_anim: s.vehicle_enter_anim,
                vehicle_exit_anim: s.vehicle_exit_anim,
                vehicle_ride_anim_loop: s.vehicle_ride_anim_loop,
                field_3_3_5_12213_034: s.field_3_3_5_12213_034,
                vehicle_exit_anim_bone: s.vehicle_exit_anim_bone,
                vehicle_enter_anim_bone: s.vehicle_enter_anim_bone,
                field_3_3_5_12213_037: s.field_3_3_5_12213_037,
                field_3_3_5_12213_038: s.field_3_3_5_12213_038,
                vehicle_ability_display: s.vehicle_ability_display,
                enter_u_i_sound_id: s.enter_u_i_sound_id,
                field_3_3_5_12213_041: s.field_3_3_5_12213_041,
                ui_skin: s.ui_skin,
                field_3_3_5_12213_043: s.field_3_3_5_12213_043,
                field_3_3_5_12213_044: s.field_3_3_5_12213_044,
                field_3_3_5_12213_045: s.field_3_3_5_12213_045,
                field_3_3_5_12213_046: s.field_3_3_5_12213_046,
                field_3_3_5_12213_047: s.field_3_3_5_12213_047,
                field_3_3_5_12213_048: s.field_3_3_5_12213_048,
                field_3_3_5_12213_049: s.field_3_3_5_12213_049,
                field_3_3_5_12213_050: s.field_3_3_5_12213_050,
                field_3_3_5_12213_051: s.field_3_3_5_12213_051,
                field_3_3_5_12213_052: s.field_3_3_5_12213_052,
                field_3_3_5_12213_053: s.field_3_3_5_12213_053,
                field_3_3_5_12213_054: s.field_3_3_5_12213_054,
                field_3_3_5_12213_055: s.field_3_3_5_12213_055,
            }).collect(),
        }
    }
    // TODO: Indexable?
