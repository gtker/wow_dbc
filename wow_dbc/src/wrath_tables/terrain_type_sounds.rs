...
impl DbcTable for TerrainTypeSounds {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (TerrainTypeSounds) int32
            let id = TerrainTypeSoundsKey::new(crate::util::read_i32_le(chunk)?);
...
mod test {
    ...
    fn terrain_type_sounds() {
        let mut file = File::open("../wrath-dbc/TerrainTypeSounds.dbc").expect("Failed to open DBC file");
