...
impl TryFrom<u32> for HolidayNamesKey {
    type Error = u32;
...
impl TryFrom<usize> for HolidayNamesKey {
    type Error = usize;
...
impl TryFrom<u64> for HolidayNamesKey {
    type Error = u64;
...
impl TryFrom<i64> for HolidayNamesKey {
    type Error = i64;
...
impl TryFrom<isize> for HolidayNamesKey {
    type Error = isize;
