...
impl DbcTable for Resistances {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (Resistances) int32
            let id = ResistancesKey::new(crate::util::read_i32_le(chunk)?);
...
impl<const S: usize> ConstResistances<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        while i < S {
            // id: primary_key (Resistances) int32
            let id = ResistancesKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // fizzle_sound_id: foreign_key (SoundKit) int32
            let fizzle_sound_id = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
...
impl From<i8> for ResistancesKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
...
impl From<i16> for ResistancesKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
...
impl From<i32> for ResistancesKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
