...
impl TryFrom<u32> for ItemVisualEffectsKey {
    type Error = u32;
...
impl TryFrom<usize> for ItemVisualEffectsKey {
    type Error = usize;
...
impl TryFrom<u64> for ItemVisualEffectsKey {
    type Error = u64;
...
impl TryFrom<i64> for ItemVisualEffectsKey {
    type Error = i64;
...
impl TryFrom<isize> for ItemVisualEffectsKey {
    type Error = isize;
...
mod test {
    ...
    fn item_visual_effects() {
        let mut file = File::open("../wrath-dbc/ItemVisualEffects.dbc").expect("Failed to open DBC file");
