...
pub struct ConstgtChanceToMeleeCritBase<const S: usize> {
    pub rows: [gtChanceToMeleeCritBaseRow; S],
}

impl<const S: usize> ConstgtChanceToMeleeCritBase<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        while i < S {
            ...
            rows[i] = gtChanceToMeleeCritBaseRow {
                data,
            };
            i += 1;
        }
