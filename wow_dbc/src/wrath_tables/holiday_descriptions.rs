...
impl TryFrom<u32> for HolidayDescriptionsKey {
    type Error = u32;
...
impl TryFrom<usize> for HolidayDescriptionsKey {
    type Error = usize;
...
impl TryFrom<u64> for HolidayDescriptionsKey {
    type Error = u64;
...
impl TryFrom<i64> for HolidayDescriptionsKey {
    type Error = i64;
...
impl TryFrom<isize> for HolidayDescriptionsKey {
    type Error = isize;
