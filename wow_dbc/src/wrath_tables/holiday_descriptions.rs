...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstHolidayDescriptions<const S: usize> {
    pub rows: [ConstHolidayDescriptionsRow; S],
}

impl<const S: usize> ConstHolidayDescriptions<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ConstHolidayDescriptionsRow {
                id: HolidayDescriptionsKey::new(0),
        ...
        while i < S {
            // id: primary_key (HolidayDescriptions) int32
            let id = HolidayDescriptionsKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            rows[i] = ConstHolidayDescriptionsRow {
                id,
                description_lang,
            };
            i += 1;
...
pub struct ConstHolidayDescriptionsRow {
    pub id: HolidayDescriptionsKey,
