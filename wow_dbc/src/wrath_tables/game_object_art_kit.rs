...
impl From<i8> for GameObjectArtKitKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
}

impl From<i16> for GameObjectArtKitKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
}

impl From<i32> for GameObjectArtKitKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
}
...
impl TryFrom<usize> for GameObjectArtKitKey {
    type Error = usize;
...
impl TryFrom<u64> for GameObjectArtKitKey {
    type Error = u64;
...
impl TryFrom<i64> for GameObjectArtKitKey {
    type Error = i64;
...
impl TryFrom<isize> for GameObjectArtKitKey {
    type Error = isize;
...
mod test {
    ...
    fn game_object_art_kit() {
        let mut file = File::open("../wrath-dbc/GameObjectArtKit.dbc").expect("Failed to open DBC file");
