...
impl TryFrom<u32> for LFGDungeonGroupKey {
    type Error = u32;
...
impl TryFrom<usize> for LFGDungeonGroupKey {
    type Error = usize;
...
impl TryFrom<u64> for LFGDungeonGroupKey {
    type Error = u64;
...
impl TryFrom<i64> for LFGDungeonGroupKey {
    type Error = i64;
...
impl TryFrom<isize> for LFGDungeonGroupKey {
    type Error = isize;
