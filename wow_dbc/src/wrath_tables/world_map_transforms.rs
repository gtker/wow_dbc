    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            WorldMapTransformsRow {
                ...
                region_offset: [0.0; 2],
                new_dungeon_map_id: DungeonMapKey::new(0),
            }
        ; S];
        ...
        while i < S {
            ...
            // new_dungeon_map_id: foreign_key (DungeonMap) int32
            let new_dungeon_map_id = DungeonMapKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
    ...
    pub fn to_owned(&self) -> WorldMapTransforms {
        WorldMapTransforms {
            rows: self.rows.iter().map(|s| WorldMapTransformsRow {
                ...
                new_dungeon_map_id: s.new_dungeon_map_id,
            }).collect(),
        }
    }
    // TODO: Indexable?
