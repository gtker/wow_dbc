...
impl TryFrom<u32> for VehicleKey {
    type Error = u32;
...
impl TryFrom<usize> for VehicleKey {
    type Error = usize;
...
impl TryFrom<u64> for VehicleKey {
    type Error = u64;
...
impl TryFrom<i64> for VehicleKey {
    type Error = i64;
...
impl TryFrom<isize> for VehicleKey {
    type Error = isize;
