...
impl DbcTable for ItemBagFamily {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (ItemBagFamily) int32
            let id = ItemBagFamilyKey::new(crate::util::read_i32_le(chunk)?);

            // name_lang: string_ref_loc (Extended)
            let name_lang = crate::util::read_extended_localized_string(chunk, &string_block)?;


            rows.push(ItemBagFamilyRow {
                id,
                name_lang,
            });
        }

        Ok(ItemBagFamily { rows, })
    }
...
impl Indexable for ItemBagFamily {
    type PrimaryKey = ItemBagFamilyKey;
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstItemBagFamily<const S: usize> {
    pub rows: [ConstItemBagFamilyRow; S],
}

impl<const S: usize> ConstItemBagFamily<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut b_offset = 20;
        let mut rows = [
            ConstItemBagFamilyRow {
                id: ItemBagFamilyKey::new(0),
        ...
        while i < S {
            // id: primary_key (ItemBagFamily) int32
            let id = ItemBagFamilyKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
    ...
    pub fn to_owned(&self) -> ItemBagFamily {
        ItemBagFamily {
            rows: self.rows.iter().map(|s| ItemBagFamilyRow {
                id: s.id,
...
pub struct ItemBagFamilyKey {
    pub id: i32
}

impl ItemBagFamilyKey {
...
impl From<i8> for ItemBagFamilyKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
...
impl From<i16> for ItemBagFamilyKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
...
impl From<i32> for ItemBagFamilyKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
...
impl From<u8> for ItemBagFamilyKey {
    fn from(v: u8) -> Self {
        Self::new(v.into())
    }
...
impl From<u16> for ItemBagFamilyKey {
    fn from(v: u16) -> Self {
        Self::new(v.into())
    }
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ItemBagFamilyRow {
    pub id: ItemBagFamilyKey,
    pub name_lang: ExtendedLocalizedString,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstItemBagFamilyRow {
    pub id: ItemBagFamilyKey,
