...
impl DbcTable for CharStartOutfit {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // display_item_id: int32[12]
            let display_item_id = crate::util::read_array_i32::<12>(chunk)?;

            // inventory_type: int32[12]
            let inventory_type = crate::util::read_array_i32::<12>(chunk)?;
...
pub struct CharStartOutfitRow {
    ...
    pub outfit_id: i8,
    pub item_id: [i32; 12],
    pub display_item_id: [i32; 12],
    pub inventory_type: [i32; 12],
}
...
mod test {
    ...
    fn char_start_outfit() {
        let mut file = File::open("../tbc-dbc/CharStartOutfit.dbc").expect("Failed to open DBC file");
