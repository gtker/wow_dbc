...
pub struct ConstParticleColor<const S: usize> {
    pub rows: [ParticleColorRow; S],
}

impl<const S: usize> ConstParticleColor<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        while i < S {
            // id: primary_key (ParticleColor) int32
            let id = ParticleColorKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
