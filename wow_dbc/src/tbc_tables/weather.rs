...
impl TryFrom<u32> for WeatherKey {
    type Error = u32;
...
impl TryFrom<usize> for WeatherKey {
    type Error = usize;
...
impl TryFrom<u64> for WeatherKey {
    type Error = u64;
...
impl TryFrom<i64> for WeatherKey {
    type Error = i64;
...
impl TryFrom<isize> for WeatherKey {
    type Error = isize;
...
mod test {
    ...
    fn weather() {
        let mut file = File::open("../tbc-dbc/Weather.dbc").expect("Failed to open DBC file");
