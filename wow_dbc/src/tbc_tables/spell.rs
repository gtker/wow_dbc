...
impl<const S: usize> ConstSpell<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        if header.record_size != 864 {
            panic!("invalid record size, expected 864")
        }

        if header.field_count != 216 {
            panic!("invalid field count, expected 216")
        }
        ...
        while i < S {
            ...
            // cast_u_i: int32
            let cast_u_i = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // shapeshift_mask: int32
            let shapeshift_mask = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // shapeshift_exclude: int32
            let shapeshift_exclude = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // required_areas_id: foreign_key (AreaGroup) int32
            let required_areas_id = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
