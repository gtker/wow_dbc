...
impl DbcTable for ChatChannels {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (ChatChannels) int32
            let id = ChatChannelsKey::new(crate::util::read_i32_le(chunk)?);
...
impl ChatChannels {
    fn write_string_block(&self, b: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            row.shortcut_lang.string_block_as_array(b)?;
        }
    ...
    fn string_block_size(&self) -> u32 {
        ...
        for row in &self.rows {
            ...
            sum += row.shortcut_lang.string_block_size();
        }
    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ConstChatChannelsRow {
                ...
                shortcut_lang: crate::ConstExtendedLocalizedString::empty(),
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (ChatChannels) int32
            let id = ChatChannelsKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // faction_group: int32
            let faction_group = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
            ...
            // shortcut_lang: string_ref_loc (Extended)
            let shortcut_lang = ConstExtendedLocalizedString::new(
                crate::util::get_string_from_block(b_offset, b, string_block),
                crate::util::get_string_from_block(b_offset + 4, b, string_block),
                crate::util::get_string_from_block(b_offset + 8, b, string_block),
                crate::util::get_string_from_block(b_offset + 12, b, string_block),
...
impl From<i8> for ChatChannelsKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
...
impl From<i16> for ChatChannelsKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
...
impl From<i32> for ChatChannelsKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
...
pub struct ConstChatChannelsRow {
    ...
    pub shortcut_lang: ConstExtendedLocalizedString,
}
