...
pub struct PetLoyalty {
    pub rows: Vec<PetLoyaltyRow>,
}
...
impl DbcTable for PetLoyalty {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (PetLoyalty) int32
            let id = PetLoyaltyKey::new(crate::util::read_i32_le(chunk)?);

            // name_lang: string_ref_loc (Extended)
            let name_lang = crate::util::read_extended_localized_string(chunk, &string_block)?;


            rows.push(PetLoyaltyRow {
                id,
                name_lang,
            });
        }
...
impl Indexable for PetLoyalty {
    type PrimaryKey = PetLoyaltyKey;
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstPetLoyalty<const S: usize> {
    pub rows: [ConstPetLoyaltyRow; S],
}

impl<const S: usize> ConstPetLoyalty<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        while i < S {
            // id: primary_key (PetLoyalty) int32
            let id = PetLoyaltyKey::new(i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
    ...
    pub fn to_owned(&self) -> PetLoyalty {
        PetLoyalty {
            rows: self.rows.iter().map(|s| PetLoyaltyRow {
                id: s.id,
...
impl From<i8> for PetLoyaltyKey {
    fn from(v: i8) -> Self {
        Self::new(v.into())
    }
...
impl From<i16> for PetLoyaltyKey {
    fn from(v: i16) -> Self {
        Self::new(v.into())
    }
...
impl From<i32> for PetLoyaltyKey {
    fn from(v: i32) -> Self {
        Self::new(v)
    }
...
impl From<u8> for PetLoyaltyKey {
    fn from(v: u8) -> Self {
        Self::new(v.into())
    }
...
impl From<u16> for PetLoyaltyKey {
    fn from(v: u16) -> Self {
        Self::new(v.into())
    }
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct PetLoyaltyRow {
    pub id: PetLoyaltyKey,
    pub name_lang: ExtendedLocalizedString,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstPetLoyaltyRow {
    pub id: PetLoyaltyKey,
