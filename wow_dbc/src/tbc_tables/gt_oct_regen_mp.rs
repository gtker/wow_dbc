...
impl DbcTable for gtOCTRegenMP {
    ...
    fn filename() -> &'static str { "gtOCTRegenMP.dbc" }
...
pub struct ConstgtOCTRegenMP<const S: usize> {
    pub rows: [gtOCTRegenMPRow; S],
}

impl<const S: usize> ConstgtOCTRegenMP<S> {
