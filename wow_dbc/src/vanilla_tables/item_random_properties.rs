...
impl DbcTable for ItemRandomProperties {
    ...
    fn write(&self, w: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            // suffix: string_ref_loc
            b.write_all(&row.suffix.string_indices_as_array(&mut string_cache))?;
...
impl TryFrom<u64> for ItemRandomPropertiesKey {
    type Error = u64;
...
impl TryFrom<usize> for ItemRandomPropertiesKey {
    type Error = usize;
...
impl TryFrom<i8> for ItemRandomPropertiesKey {
    type Error = i8;
...
impl TryFrom<i16> for ItemRandomPropertiesKey {
    type Error = i16;
...
impl TryFrom<i32> for ItemRandomPropertiesKey {
    type Error = i32;
...
impl TryFrom<i64> for ItemRandomPropertiesKey {
    type Error = i64;
...
impl TryFrom<isize> for ItemRandomPropertiesKey {
    type Error = isize;
...
mod test {
    ...
    fn item_random_properties() {
        let mut file = File::open("../vanilla-dbc/ItemRandomProperties.dbc").expect("Failed to open DBC file");
