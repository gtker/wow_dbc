...
impl TryFrom<i8> for ItemVisualsKey {
    type Error = i8;
...
impl TryFrom<i16> for ItemVisualsKey {
    type Error = i16;
...
impl TryFrom<i32> for ItemVisualsKey {
    type Error = i32;
...
mod test {
    ...
    fn item_visuals() {
        let mut file = File::open("../vanilla-dbc/ItemVisuals.dbc").expect("Failed to open DBC file");
