...
impl DbcTable for Startup_Strings {
    ...
    fn write(&self, w: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            // startup_string: string_ref_loc
            b.write_all(&row.startup_string.string_indices_as_array(&mut string_cache))?;
...
mod test {
    ...
    fn startup_strings() {
        let mut file = File::open("../vanilla-dbc/Startup_Strings.dbc").expect("Failed to open DBC file");
