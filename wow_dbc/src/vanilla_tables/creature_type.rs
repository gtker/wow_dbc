...
impl TryFrom<i8> for CreatureTypeKey {
    type Error = i8;
...
impl TryFrom<i16> for CreatureTypeKey {
    type Error = i16;
...
impl TryFrom<i32> for CreatureTypeKey {
    type Error = i32;
...
mod test {
    ...
    fn creature_type() {
        let mut file = File::open("../vanilla-dbc/CreatureType.dbc").expect("Failed to open DBC file");
