    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            DeathThudLookupsRow {
                ...
                sound_entry_water: SoundEntriesKey::new(0),
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (DeathThudLookups) uint32
            let id = DeathThudLookupsKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // sound_entry_water: foreign_key (SoundEntries) uint32
            let sound_entry_water = SoundEntriesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
