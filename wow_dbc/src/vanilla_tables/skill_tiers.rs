...
impl From<u32> for SkillTiersKey {
    fn from(v: u32) -> Self {
        Self::new(v)
    }
}

impl TryFrom<u64> for SkillTiersKey {
    type Error = u64;
...
impl TryFrom<usize> for SkillTiersKey {
    type Error = usize;
...
impl TryFrom<i8> for SkillTiersKey {
    type Error = i8;
...
impl TryFrom<i16> for SkillTiersKey {
    type Error = i16;
...
impl TryFrom<i32> for SkillTiersKey {
    type Error = i32;
...
impl TryFrom<i64> for SkillTiersKey {
    type Error = i64;
...
impl TryFrom<isize> for SkillTiersKey {
    type Error = isize;
...
mod test {
    ...
    fn skill_tiers() {
        let mut file = File::open("../vanilla-dbc/SkillTiers.dbc").expect("Failed to open DBC file");
