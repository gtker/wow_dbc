...
impl TryFrom<u64> for PackageKey {
    type Error = u64;
...
impl TryFrom<usize> for PackageKey {
    type Error = usize;
...
impl TryFrom<i8> for PackageKey {
    type Error = i8;
...
impl TryFrom<i16> for PackageKey {
    type Error = i16;
...
impl TryFrom<i32> for PackageKey {
    type Error = i32;
...
impl TryFrom<i64> for PackageKey {
    type Error = i64;
...
impl TryFrom<isize> for PackageKey {
    type Error = isize;
...
mod test {
    ...
    fn package() {
        let mut file = File::open("../vanilla-dbc/Package.dbc").expect("Failed to open DBC file");
