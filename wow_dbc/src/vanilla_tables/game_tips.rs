...
impl TryFrom<i8> for GameTipsKey {
    type Error = i8;
...
impl TryFrom<i16> for GameTipsKey {
    type Error = i16;
...
impl TryFrom<i32> for GameTipsKey {
    type Error = i32;
...
mod test {
    ...
    fn game_tips() {
        let mut file = File::open("../vanilla-dbc/GameTips.dbc").expect("Failed to open DBC file");
