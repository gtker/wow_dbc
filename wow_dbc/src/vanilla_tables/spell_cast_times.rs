...
impl TryFrom<i8> for SpellCastTimesKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellCastTimesKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellCastTimesKey {
    type Error = i32;
...
mod test {
    ...
    fn spell_cast_times() {
        let mut file = File::open("../vanilla-dbc/SpellCastTimes.dbc").expect("Failed to open DBC file");
