...
impl TryFrom<u64> for LanguagesKey {
    type Error = u64;
...
impl TryFrom<usize> for LanguagesKey {
    type Error = usize;
...
impl TryFrom<i8> for LanguagesKey {
    type Error = i8;
...
impl TryFrom<i16> for LanguagesKey {
    type Error = i16;
...
impl TryFrom<i32> for LanguagesKey {
    type Error = i32;
...
impl TryFrom<i64> for LanguagesKey {
    type Error = i64;
...
impl TryFrom<isize> for LanguagesKey {
    type Error = isize;
...
mod test {
    ...
    fn languages() {
        let mut file = File::open("../vanilla-dbc/Languages.dbc").expect("Failed to open DBC file");
