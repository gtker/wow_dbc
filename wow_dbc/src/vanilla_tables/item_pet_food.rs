...
impl TryFrom<u64> for ItemPetFoodKey {
    type Error = u64;
...
impl TryFrom<usize> for ItemPetFoodKey {
    type Error = usize;
...
impl TryFrom<i8> for ItemPetFoodKey {
    type Error = i8;
...
impl TryFrom<i16> for ItemPetFoodKey {
    type Error = i16;
...
impl TryFrom<i32> for ItemPetFoodKey {
    type Error = i32;
...
impl TryFrom<i64> for ItemPetFoodKey {
    type Error = i64;
...
impl TryFrom<isize> for ItemPetFoodKey {
    type Error = isize;
...
mod test {
    ...
    fn item_pet_food() {
        let mut file = File::open("../vanilla-dbc/ItemPetFood.dbc").expect("Failed to open DBC file");
