...
impl TryFrom<i8> for UISoundLookupsKey {
    type Error = i8;
...
impl TryFrom<i16> for UISoundLookupsKey {
    type Error = i16;
...
impl TryFrom<i32> for UISoundLookupsKey {
    type Error = i32;
...
mod test {
    ...
    fn ui_sound_lookups() {
        let mut file = File::open("../vanilla-dbc/UISoundLookups.dbc").expect("Failed to open DBC file");
