    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ConstCreatureModelDataRow {
                ...
                footprint_texture: FootprintTexturesKey::new(0),
                footprint_texture_length: 0.0,
                footprint_texture_width: 0.0,
                footprint_texture_scale: 0.0,
                foley_material: 0,
        ...
        while i < S {
            // id: primary_key (CreatureModelData) uint32
            let id = CreatureModelDataKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // footprint_texture: foreign_key (FootprintTextures) uint32
            let footprint_texture = FootprintTexturesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // footprint_texture_scale: float
            let footprint_texture_scale = crate::util::ct_u32_to_f32([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // foley_material: int32
            let foley_material = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
