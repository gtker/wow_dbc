...
impl DbcTable for QuestInfo {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (QuestInfo) uint32
            let id = QuestInfoKey::new(crate::util::read_u32_le(chunk)?);
...
impl<const S: usize> ConstQuestInfo<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        while i < S {
            // id: primary_key (QuestInfo) uint32
            let id = QuestInfoKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
...
impl From<u32> for QuestInfoKey {
    fn from(v: u32) -> Self {
        Self::new(v)
    }
