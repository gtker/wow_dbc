...
impl TryFrom<i8> for QuestInfoKey {
    type Error = i8;
...
impl TryFrom<i16> for QuestInfoKey {
    type Error = i16;
...
impl TryFrom<i32> for QuestInfoKey {
    type Error = i32;
...
mod test {
    ...
    fn quest_info() {
        let mut file = File::open("../vanilla-dbc/QuestInfo.dbc").expect("Failed to open DBC file");
