...
impl DbcTable for BankBagSlotPrices {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (BankBagSlotPrices) uint32
            let id = BankBagSlotPricesKey::new(crate::util::read_u32_le(chunk)?);
...
impl From<u32> for BankBagSlotPricesKey {
    fn from(v: u32) -> Self {
        Self::new(v)
    }
}
...
impl TryFrom<i8> for BankBagSlotPricesKey {
    type Error = i8;
...
impl TryFrom<i16> for BankBagSlotPricesKey {
    type Error = i16;
...
impl TryFrom<i32> for BankBagSlotPricesKey {
    type Error = i32;
...
mod test {
    ...
    fn bank_bag_slot_prices() {
        let mut file = File::open("../vanilla-dbc/BankBagSlotPrices.dbc").expect("Failed to open DBC file");
