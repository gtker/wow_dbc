...
impl TryFrom<i8> for SpellRadiusKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellRadiusKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellRadiusKey {
    type Error = i32;
...
mod test {
    ...
    fn spell_radius() {
        let mut file = File::open("../vanilla-dbc/SpellRadius.dbc").expect("Failed to open DBC file");
