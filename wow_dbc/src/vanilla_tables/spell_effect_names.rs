...
impl TryFrom<u64> for SpellEffectNamesKey {
    type Error = u64;
...
impl TryFrom<usize> for SpellEffectNamesKey {
    type Error = usize;
...
impl TryFrom<i64> for SpellEffectNamesKey {
    type Error = i64;
...
impl TryFrom<isize> for SpellEffectNamesKey {
    type Error = isize;
