...
pub struct SpellEffectNames {
    pub rows: Vec<SpellEffectNamesRow>,
}
...
impl DbcTable for SpellEffectNames {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (SpellEffectNames) uint32
            let id = SpellEffectNamesKey::new(crate::util::read_u32_le(chunk)?);

            // name: string_ref_loc
            let name = crate::util::read_localized_string(chunk, &string_block)?;


            rows.push(SpellEffectNamesRow {
                id,
                name,
            });
        }

        Ok(SpellEffectNames { rows, })
    }
...
impl Indexable for SpellEffectNames {
    type PrimaryKey = SpellEffectNamesKey;
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ConstSpellEffectNames<const S: usize> {
    pub rows: [ConstSpellEffectNamesRow; S],
}

impl<const S: usize> ConstSpellEffectNames<S> {
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ConstSpellEffectNamesRow {
                id: SpellEffectNamesKey::new(0),
        ...
        while i < S {
            // id: primary_key (SpellEffectNames) uint32
            let id = SpellEffectNamesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            rows[i] = ConstSpellEffectNamesRow {
                id,
                name,
            };
            i += 1;
...
pub struct SpellEffectNamesKey {
    pub id: u32
}

impl SpellEffectNamesKey {
...
pub struct ConstSpellEffectNamesRow {
    pub id: SpellEffectNamesKey,
