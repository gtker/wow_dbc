...
impl TryFrom<u64> for StableSlotPricesKey {
    type Error = u64;
...
impl TryFrom<usize> for StableSlotPricesKey {
    type Error = usize;
...
impl TryFrom<i8> for StableSlotPricesKey {
    type Error = i8;
...
impl TryFrom<i16> for StableSlotPricesKey {
    type Error = i16;
...
impl TryFrom<i32> for StableSlotPricesKey {
    type Error = i32;
...
impl TryFrom<i64> for StableSlotPricesKey {
    type Error = i64;
...
impl TryFrom<isize> for StableSlotPricesKey {
    type Error = isize;
...
mod test {
    ...
    fn stable_slot_prices() {
        let mut file = File::open("../vanilla-dbc/StableSlotPrices.dbc").expect("Failed to open DBC file");
