...
impl DbcTable for FootprintTextures {
    ...
    fn write(&self, w: &mut impl Write) -> Result<(), std::io::Error> {
        ...
        for row in &self.rows {
            ...
            // footstep_file_path: string_ref
            b.write_all(&string_cache.add_string(&row.footstep_file_path).to_le_bytes())?;
...
mod test {
    ...
    fn footprint_textures() {
        let mut file = File::open("../vanilla-dbc/FootprintTextures.dbc").expect("Failed to open DBC file");
