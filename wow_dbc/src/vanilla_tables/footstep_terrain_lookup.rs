    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            FootstepTerrainLookupRow {
                ...
                creature_footstep: GroundEffectDoodadKey::new(0),
                terrain_type: TerrainTypeKey::new(0),
                sound_entry: SoundEntriesKey::new(0),
                sound_entry_splash: SoundEntriesKey::new(0),
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (FootstepTerrainLookup) uint32
            let id = FootstepTerrainLookupKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // creature_footstep: foreign_key (GroundEffectDoodad) uint32
            let creature_footstep = GroundEffectDoodadKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // terrain_type: foreign_key (TerrainType) uint32
            let terrain_type = TerrainTypeKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // sound_entry_splash: foreign_key (SoundEntries) uint32
            let sound_entry_splash = SoundEntriesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
