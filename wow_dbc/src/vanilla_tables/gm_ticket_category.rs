...
impl TryFrom<i8> for GMTicketCategoryKey {
    type Error = i8;
...
impl TryFrom<i16> for GMTicketCategoryKey {
    type Error = i16;
...
impl TryFrom<i32> for GMTicketCategoryKey {
    type Error = i32;
...
mod test {
    ...
    fn gm_ticket_category() {
        let mut file = File::open("../vanilla-dbc/GMTicketCategory.dbc").expect("Failed to open DBC file");
