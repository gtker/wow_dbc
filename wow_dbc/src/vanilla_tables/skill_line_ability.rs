    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            SkillLineAbilityRow {
                ...
                exclude_race: ChrRacesKey::new(0),
                exclude_class: ChrClassesKey::new(0),
                superseded_by: SpellKey::new(0),
                acquire_method: 0,
        ...
        while i < S {
            // id: primary_key (SkillLineAbility) uint32
            let id = SkillLineAbilityKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // exclude_race: foreign_key (ChrRaces) uint32
            let exclude_race = ChrRacesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // exclude_class: foreign_key (ChrClasses) uint32
            let exclude_class = ChrClassesKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // superseded_by: foreign_key (Spell) uint32
            let superseded_by = SpellKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // num_skills_up: int32
            let num_skills_up = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;

            // unknown_padding: int32
            let unknown_padding = i32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]);
            b_offset += 4;
