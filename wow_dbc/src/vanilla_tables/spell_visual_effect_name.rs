...
impl TryFrom<i8> for SpellVisualEffectNameKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellVisualEffectNameKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellVisualEffectNameKey {
    type Error = i32;
...
mod test {
    ...
    fn spell_visual_effect_name() {
        let mut file = File::open("../vanilla-dbc/SpellVisualEffectName.dbc").expect("Failed to open DBC file");
