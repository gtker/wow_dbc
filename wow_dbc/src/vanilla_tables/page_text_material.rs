...
impl DbcTable for PageTextMaterial {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // id: primary_key (PageTextMaterial) uint32
            let id = PageTextMaterialKey::new(crate::util::read_u32_le(chunk)?);
...
impl TryFrom<u64> for PageTextMaterialKey {
    type Error = u64;
...
impl TryFrom<usize> for PageTextMaterialKey {
    type Error = usize;
...
impl TryFrom<i8> for PageTextMaterialKey {
    type Error = i8;
...
impl TryFrom<i16> for PageTextMaterialKey {
    type Error = i16;
...
impl TryFrom<i32> for PageTextMaterialKey {
    type Error = i32;
...
impl TryFrom<i64> for PageTextMaterialKey {
    type Error = i64;
...
impl TryFrom<isize> for PageTextMaterialKey {
    type Error = isize;
...
mod test {
    ...
    fn page_text_material() {
        let mut file = File::open("../vanilla-dbc/PageTextMaterial.dbc").expect("Failed to open DBC file");
