...
impl TryFrom<u64> for TerrainTypeSoundsKey {
    type Error = u64;
...
impl TryFrom<usize> for TerrainTypeSoundsKey {
    type Error = usize;
...
impl TryFrom<i8> for TerrainTypeSoundsKey {
    type Error = i8;
...
impl TryFrom<i16> for TerrainTypeSoundsKey {
    type Error = i16;
...
impl TryFrom<i32> for TerrainTypeSoundsKey {
    type Error = i32;
...
impl TryFrom<i64> for TerrainTypeSoundsKey {
    type Error = i64;
...
impl TryFrom<isize> for TerrainTypeSoundsKey {
    type Error = isize;
...
mod test {
    ...
    fn terrain_type_sounds() {
        let mut file = File::open("../vanilla-dbc/TerrainTypeSounds.dbc").expect("Failed to open DBC file");
