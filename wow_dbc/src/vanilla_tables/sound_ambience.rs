...
impl TryFrom<i8> for SoundAmbienceKey {
    type Error = i8;
...
impl TryFrom<i16> for SoundAmbienceKey {
    type Error = i16;
...
impl TryFrom<i32> for SoundAmbienceKey {
    type Error = i32;
...
mod test {
    ...
    fn sound_ambience() {
        let mut file = File::open("../vanilla-dbc/SoundAmbience.dbc").expect("Failed to open DBC file");
