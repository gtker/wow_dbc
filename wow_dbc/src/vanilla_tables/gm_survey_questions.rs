    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            ConstGMSurveyQuestionsRow {
                ...
                question: crate::ConstLocalizedString::empty(),
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (GMSurveyQuestions) uint32
            let id = GMSurveyQuestionsKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // question: string_ref_loc
            let question = ConstLocalizedString::new(
...
pub struct ConstGMSurveyQuestionsRow {
    pub id: GMSurveyQuestionsKey,
    pub question: ConstLocalizedString,
}
