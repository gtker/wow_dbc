...
impl TryFrom<i8> for SpellDispelTypeKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellDispelTypeKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellDispelTypeKey {
    type Error = i32;
...
mod test {
    ...
    fn spell_dispel_type() {
        let mut file = File::open("../vanilla-dbc/SpellDispelType.dbc").expect("Failed to open DBC file");
