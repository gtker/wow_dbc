...
impl TryFrom<u64> for ServerMessagesKey {
    type Error = u64;
...
impl TryFrom<usize> for ServerMessagesKey {
    type Error = usize;
...
impl TryFrom<i8> for ServerMessagesKey {
    type Error = i8;
...
impl TryFrom<i16> for ServerMessagesKey {
    type Error = i16;
...
impl TryFrom<i32> for ServerMessagesKey {
    type Error = i32;
...
impl TryFrom<i64> for ServerMessagesKey {
    type Error = i64;
...
impl TryFrom<isize> for ServerMessagesKey {
    type Error = isize;
...
mod test {
    ...
    fn server_messages() {
        let mut file = File::open("../vanilla-dbc/ServerMessages.dbc").expect("Failed to open DBC file");
