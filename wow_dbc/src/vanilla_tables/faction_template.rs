    ...
    pub const fn const_read(b: &'static [u8], header: &DbcHeader) -> Self {
        ...
        let mut rows = [
            FactionTemplateRow {
                ...
                enemy_group: FactionGroupKey::new(0),
                enemies: [0; 4],
                friends: [0; 4],
            }
        ; S];
        ...
        while i < S {
            // id: primary_key (FactionTemplate) uint32
            let id = FactionTemplateKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
            ...
            // friend_group: foreign_key (FactionGroup) uint32
            let friend_group = FactionGroupKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;

            // enemy_group: foreign_key (FactionGroup) uint32
            let enemy_group = FactionGroupKey::new(u32::from_le_bytes([b[b_offset + 0], b[b_offset + 1], b[b_offset + 2], b[b_offset + 3]]));
            b_offset += 4;
