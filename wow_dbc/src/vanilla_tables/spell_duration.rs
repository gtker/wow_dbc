...
impl TryFrom<i8> for SpellDurationKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellDurationKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellDurationKey {
    type Error = i32;
...
mod test {
    ...
    fn spell_duration() {
        let mut file = File::open("../vanilla-dbc/SpellDuration.dbc").expect("Failed to open DBC file");
