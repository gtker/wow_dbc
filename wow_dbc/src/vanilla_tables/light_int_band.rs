...
impl TryFrom<u64> for LightIntBandKey {
    type Error = u64;
...
impl TryFrom<usize> for LightIntBandKey {
    type Error = usize;
...
impl TryFrom<i8> for LightIntBandKey {
    type Error = i8;
...
impl TryFrom<i16> for LightIntBandKey {
    type Error = i16;
...
impl TryFrom<i32> for LightIntBandKey {
    type Error = i32;
...
impl TryFrom<i64> for LightIntBandKey {
    type Error = i64;
...
impl TryFrom<isize> for LightIntBandKey {
    type Error = isize;
...
mod test {
    ...
    fn light_int_band() {
        let mut file = File::open("../vanilla-dbc/LightIntBand.dbc").expect("Failed to open DBC file");
