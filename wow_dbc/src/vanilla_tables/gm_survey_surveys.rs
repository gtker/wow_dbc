...
impl TryFrom<i8> for GMSurveySurveysKey {
    type Error = i8;
...
impl TryFrom<i16> for GMSurveySurveysKey {
    type Error = i16;
...
impl TryFrom<i32> for GMSurveySurveysKey {
    type Error = i32;
...
mod test {
    ...
    fn gm_survey_surveys() {
        let mut file = File::open("../vanilla-dbc/GMSurveySurveys.dbc").expect("Failed to open DBC file");
