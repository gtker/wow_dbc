...
impl TryFrom<u64> for SpellAuraNamesKey {
    type Error = u64;
...
impl TryFrom<usize> for SpellAuraNamesKey {
    type Error = usize;
...
impl TryFrom<i8> for SpellAuraNamesKey {
    type Error = i8;
...
impl TryFrom<i16> for SpellAuraNamesKey {
    type Error = i16;
...
impl TryFrom<i32> for SpellAuraNamesKey {
    type Error = i32;
...
impl TryFrom<i64> for SpellAuraNamesKey {
    type Error = i64;
...
impl TryFrom<isize> for SpellAuraNamesKey {
    type Error = isize;
