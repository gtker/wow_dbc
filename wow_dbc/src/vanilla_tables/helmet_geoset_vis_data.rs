...
impl TryFrom<i8> for HelmetGeosetVisDataKey {
    type Error = i8;
...
impl TryFrom<i16> for HelmetGeosetVisDataKey {
    type Error = i16;
...
impl TryFrom<i32> for HelmetGeosetVisDataKey {
    type Error = i32;
...
mod test {
    ...
    fn helmet_geoset_vis_data() {
        let mut file = File::open("../vanilla-dbc/HelmetGeosetVisData.dbc").expect("Failed to open DBC file");
