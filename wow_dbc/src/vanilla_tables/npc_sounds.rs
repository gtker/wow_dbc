...
impl TryFrom<i8> for NPCSoundsKey {
    type Error = i8;
...
impl TryFrom<i16> for NPCSoundsKey {
    type Error = i16;
...
impl TryFrom<i32> for NPCSoundsKey {
    type Error = i32;
...
mod test {
    ...
    fn npc_sounds() {
        let mut file = File::open("../vanilla-dbc/NPCSounds.dbc").expect("Failed to open DBC file");
