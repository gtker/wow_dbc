...
impl TryFrom<u64> for UnitBloodLevelsKey {
    type Error = u64;
...
impl TryFrom<usize> for UnitBloodLevelsKey {
    type Error = usize;
...
impl TryFrom<i8> for UnitBloodLevelsKey {
    type Error = i8;
...
impl TryFrom<i16> for UnitBloodLevelsKey {
    type Error = i16;
...
impl TryFrom<i32> for UnitBloodLevelsKey {
    type Error = i32;
...
impl TryFrom<i64> for UnitBloodLevelsKey {
    type Error = i64;
...
impl TryFrom<isize> for UnitBloodLevelsKey {
    type Error = isize;
...
mod test {
    ...
    fn unit_blood_levels() {
        let mut file = File::open("../vanilla-dbc/UnitBloodLevels.dbc").expect("Failed to open DBC file");
