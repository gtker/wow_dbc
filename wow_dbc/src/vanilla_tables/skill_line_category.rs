...
impl DbcTable for SkillLineCategory {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            let id = SkillLineCategoryKey::new(crate::util::read_u32_le(chunk)?);
...
impl TryFrom<i8> for SkillLineCategoryKey {
    type Error = i8;
...
impl TryFrom<i16> for SkillLineCategoryKey {
    type Error = i16;
...
impl TryFrom<i32> for SkillLineCategoryKey {
    type Error = i32;
...
mod test {
    ...
    fn skill_line_category() {
        let mut file = File::open("../vanilla-dbc/SkillLineCategory.dbc").expect("Failed to open DBC file");
