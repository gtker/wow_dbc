...
use wow_dbc::{DbcTable, ExtendedLocalizedString};
...
pub(crate) fn get_sql_for(name: &str) -> Result<(&'static str, &'static str, &'static str), SqliteError> {
    match name {
        ...
        "BattlemasterList" => Ok(BattlemasterList()),
        ...
        "DeclinedWord" => Ok(DeclinedWord()),
        "DeclinedWordCases" => Ok(DeclinedWordCases()),
        ...
        "GameTables" => Ok(GameTables()),
        "GameTips" => Ok(GameTips()),
        "GemProperties" => Ok(GemProperties()),
        ...
        "SpellItemEnchantmentCondition" => Ok(SpellItemEnchantmentCondition()),
        "SpellMechanic" => Ok(SpellMechanic()),
        "SpellMissileMotion" => Ok(SpellMissileMotion()),
        ...
        "SummonProperties" => Ok(SummonProperties()),
        "Talent" => Ok(Talent()),
        ...
        "TotemCategory" => Ok(TotemCategory()),
        "TransportAnimation" => Ok(TransportAnimation()),
        "TransportPhysics" => Ok(TransportPhysics()),
        ...
        "WorldMapTransforms" => Ok(WorldMapTransforms()),
        "WorldSafeLocs" => Ok(WorldSafeLocs()),
        "WorldStateUI" => Ok(WorldStateUI()),
        "WorldStateZoneSounds" => Ok(WorldStateZoneSounds()),
        "WowError_Strings" => Ok(WowError_Strings()),
        "ZoneIntroMusicTable" => Ok(ZoneIntroMusicTable()),
        "ZoneMusic" => Ok(ZoneMusic()),
        "gtChanceToMeleeCrit" => Ok(gtChanceToMeleeCrit()),
        "gtChanceToMeleeCritBase" => Ok(gtChanceToMeleeCritBase()),
        "gtChanceToSpellCrit" => Ok(gtChanceToSpellCrit()),
        "gtChanceToSpellCritBase" => Ok(gtChanceToSpellCritBase()),
        "gtCombatRatings" => Ok(gtCombatRatings()),
        "gtNPCManaCostScaler" => Ok(gtNPCManaCostScaler()),
        "gtOCTRegenHP" => Ok(gtOCTRegenHP()),
        "gtOCTRegenMP" => Ok(gtOCTRegenMP()),
        "gtRegenHPPerSpt" => Ok(gtRegenHPPerSpt()),
        "gtRegenMPPerSpt" => Ok(gtRegenMPPerSpt()),
        _ => Err(SqliteError::FilenameNotFound { name: name.to_string() }),
    }
}
