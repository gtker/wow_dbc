    ...
    match file_name {
        ...
        "Map.dbc" => {
            ...
            for row in data.rows() {
                ...
                row.field_0_8_0_3734_004,
                row.field_0_8_0_3734_005,
                row.field_1_5_0_4442_006,
...
pub(crate) fn Map() -> (&'static str, &'static str) {
    ...
    "CREATE TABLE IF NOT EXISTS Map (
        ...
        field_0_8_0_3734_004 INTEGER  NOT NULL,
        field_0_8_0_3734_005 INTEGER  NOT NULL,
        field_1_5_0_4442_006 INTEGER  NOT NULL,
