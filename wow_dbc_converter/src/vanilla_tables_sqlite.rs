...
pub(crate) fn write_to_sqlite(file_name: &str, file_contents: &mut &[u8], options: &Options) {
    ...
    match file_name {
        ...
        "SpellEffectNames.dbc" => {
            let data = spell_effect_names::SpellEffectNames::read(file_contents).unwrap();
        ...
        "PetLoyalty.dbc" => {
            let data = pet_loyalty::PetLoyalty::read(file_contents).unwrap();
        ...
        "SpellAuraNames.dbc" => {
            let data = spell_aura_names::SpellAuraNames::read(file_contents).unwrap();
        ...
        "CharacterCreateCameras.dbc" => {
            let data = character_create_cameras::CharacterCreateCameras::read(file_contents).unwrap();
        ...
        "SoundCharacterMacroLines.dbc" => {
            let data = sound_character_macro_lines::SoundCharacterMacroLines::read(file_contents).unwrap();
...
pub(crate) fn VideoHardware() -> (&'static str, &'static str) {
    ...
    "CREATE TABLE IF NOT EXISTS VideoHardware (
        ...
        unknown_14 INTEGER NOT NULL,
        unknown_15 INTEGER NOT NULL,
        unknown_16 INTEGER NOT NULL,
        unknown_17 INTEGER NOT NULL,
        unknown_18 INTEGER NOT NULL,
        unknown_19 INTEGER NOT NULL,
        unknown_20 INTEGER NOT NULL
    );"
    ,
...
pub(crate) fn Spell() -> (&'static str, &'static str) {
    ...
    "CREATE TABLE IF NOT EXISTS Spell (
        ...
        attributes_ex_0 INTEGER NOT NULL,
        attributes_ex_1 INTEGER NOT NULL,
        attributes_ex_2 INTEGER NOT NULL,
        attributes_ex_3 INTEGER NOT NULL,
