...
impl DbcTable for Map {
    ...
    fn read(b: &mut impl std::io::Read) -> Result<Self, crate::DbcError> {
        ...
        for mut chunk in r.chunks(header.record_size as usize) {
            ...
            // field_2_0_0_5610_018_lang: string_ref_loc
            let field_2_0_0_5610_018_lang = crate::util::read_localized_string(chunk, &string_block)?;

            // field_2_0_0_5610_019_lang: string_ref_loc
            let field_2_0_0_5610_019_lang = crate::util::read_localized_string(chunk, &string_block)?;

            // field_2_0_0_5610_020_lang: string_ref_loc
            let field_2_0_0_5610_020_lang = crate::util::read_localized_string(chunk, &string_block)?;
...
pub struct MapRow {
    ...
    pub field_2_0_0_5610_018_lang: LocalizedString,
    pub field_2_0_0_5610_019_lang: LocalizedString,
    pub field_2_0_0_5610_020_lang: LocalizedString,
