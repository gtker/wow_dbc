...
use crate::tables::cinematic_sequences::*;
use crate::tables::creature_display_info::*;
use crate::tables::creature_type::*;
use crate::tables::faction_template::*;
use crate::tables::sound_entries::*;
use crate::tables::spell::*;
...
mod test {
    ...
    #[test]
    fn chr_races() {
        let contents = include_bytes!("../../../dbc/ChrRaces.dbc");
